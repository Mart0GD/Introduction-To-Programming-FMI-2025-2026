...
int main()
{
    ...
    int myInt; // memory is initialized with garbage value

    // Definition: <type> <variable_name> = <value>;
    myInt = 42; // memory is initialized with the value 42

    // Declaration + Definition
    int myOtherInt = 100; // memory is initialized with the value 100
